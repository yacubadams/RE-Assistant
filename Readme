...
| File | Stage | Contents |
|------|-------|----------|
| [Interview Transcript — Prof. H. Femmer](Henning_Femmer_Interview_13_May_2026.md) | Source | Primary elicitation source — verbatim. All requirements trace back to this document. |
| [Prompt Chain — P1 to P6](Prompt_Chain_P1_to_P6_RE_Assistant_Tool.md) | Reference | Every prompt used to produce this artifact chain — for reproduction and audit |
...
| [SESL v1.2 — Formal Requirements](sesl/SESL_Requirements_RE_Assistant_v1.2.md) | P4 | Six formal requirements FR-01–FR-06 + Glossary |
| [P5 — CPRE Quality Review](pipeline/P5_CPRE_Quality_Review_RE_Assistant_Tool.md) | P5 | Quality assessment — criterion verdicts, hallucination flags, corrective actions |
| [P6 — Cascade Analysis](pipeline/P6_Cascade_Analysis_RE_Assistant_Tool.md) | P6 | Cascade findings, soft goal / NFR cross-check, corrections applied in v1.2 |
...
P3 — Obstacle Analysis         OB-L1a through OB-L3b
        │
        ▼
P4 — SESL Authoring            FR-01 through FR-06  →  v1.0
        │
        ▼
P5 — CPRE Quality Review       Ambiguity, testability, hallucination flags  →  v1.1
        │
        ▼
P6 — Cascade Correction        4 cascades found and resolved  →  v1.2
        │
        ▼
...
| `v1.3` | P7 (planned) | Stakeholder confirmation — suggestion ceiling, contribution detection criteria, authorisation gap |
